...
{
    auto stage = PXR_NS::UsdStage::CreateInMemory();
    auto broker1 = PXR_NS::NoticeBroker::Create(stage);
    ASSERT_EQ(broker1->GetCurrentCount(), 2);

    auto broker2 = PXR_NS::NoticeBroker::Create(stage);
    ...
    auto broker3 = PXR_NS::NoticeBroker::Create(otherStage);
...
TEST(BrokerTest, CleanRegistry)
{
    ...
    PXR_NS::NoticeBroker::Create(stage2);
